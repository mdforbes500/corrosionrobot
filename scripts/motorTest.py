...
def extendRack():
	servo_kit_c.continuous_servo[rack_servo].throttle = 0.3
...
def spinFrontCW():
	servo_kit_c.continuous_servo[front_package].throttle = 0.3
...
def spinRearCW():
	servo_kit_c.continuous_servo[rear_package].throttle = 0.3
